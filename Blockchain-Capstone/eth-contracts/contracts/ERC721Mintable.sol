...
contract Ownable {
    ...
    event transferedOwnership(address _owner, address newOwner);
    function transferOwnership(address newOwner) public onlyOwner {
        // TODO add functionality to transfer control of the contract to a newOwner.
        // make sure the new owner is a real address
        require(newOwner != address(0));
        _owner = newOwner;
        emit transferedOwnership(_owner, newOwner);
    }
}
...
contract Pausable is Ownable {
    ...
    event Paused(address triggeredAddress);
    event Unpaused(address triggeredAddress);
    ...
    modifier paused() {
        require(_paused == true, "currently unpaused");
        _;
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "new address cannot be the current owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender), "required the msg sender to be the owner of the contract or approved");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "required that the from address is the owner");
...
contract UdacityERC721Token is ERC721Metadata {
    constructor() ERC721Metadata('Udacity Token', 'UTK', 'https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/') public { }
